...
import { Mail, Lock, ArrowRight, Video, Trophy, Users } from 'lucide-react';
      ...
      <div className="bg-black p-12 flex-col rounded-4xl justify-center relative overflow-hidden hidden lg:flex h-full">
        ...
        <div className="relative z-10 space-y-3 max-w-md mx-auto w-full">
          ...
          <div className="bg-white rounded-[32px] p-5 shadow-2xl transform rotate-1 hover:rotate-0 transition-all duration-500 border border-zinc-100 relative group">
            <span className="absolute top-4 right-4 bg-zinc-100 text-zinc-800 text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-wider z-10">
              Simulation
            </span>
          ...
          <div className="bg-white/95 backdrop-blur-md p-4 rounded-2xl shadow-xl transform -rotate-2 hover:rotate-0 transition-all duration-300 max-w-[280px] -translate-y-8 -translate-x-6 border border-zinc-100">
            ...
            <div className="flex items-center justify-between pt-2 border-t border-zinc-100">
              <span className="text-[10px] text-zinc-400 font-bold tracking-tight">Success Stories: <span className="text-blue-600 cursor-pointer hover:underline">View All</span></span>
      ...
      <div className="bg-white px-8 md:px-16 lg:px-24 flex flex-col justify-center h-full">
        <div className="max-w-md w-full mx-auto space-y-8">
          <div>
            ...
            <p className="text-blue-600 font-bold text-2xs tracking-wide uppercase mb-1">Welcome Back</p>
            <h1 className="text-zinc-900 text-4xl font-black leading-none tracking-tight">
              LOG IN TO INTERVUE
            </h1>
            <p className="text-zinc-500 text-sm mt-2 font-medium">
              Pick up right where you left off and keep sharpening your interview skills.
            </p>
          </div>
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <button onClick = {handleLogin} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-black py-4 rounded-2xl transition-all shadow-lg shadow-blue-100 flex items-center justify-center gap-2 group mt-2 text-sm tracking-wide">
              Sign In
          ...
          <p className="text-center text-zinc-500 text-xs font-medium">
            Don't have an account yet? <Link href="/sign-up" className="text-blue-600 font-bold hover:underline ml-1">Create Account</Link>
          </p>
        </div>
      </div>
